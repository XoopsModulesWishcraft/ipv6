...
$fee = 0.50 * 340000000000000000000000000000000000000;
$interest = 0.27;
$period = 3600 * 24 * 7 * 4;
$when = strtotime("2021-12-08");
...
$xoopsOption['template_main'] = 'ipv6_index.tpl';
...
$GLOBALS['xoopsTpl']->assign('interest', $segments);
	$GLOBALS['xoopsTpl']->assign('xoops_pagetitle', "IPv6 -- $ " . number_format($due, 2) . " AUD due Right now IP Address Stack 2 @ChronolabsCoop");	
